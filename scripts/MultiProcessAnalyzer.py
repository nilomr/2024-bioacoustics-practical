...
from birdnetlib import MultiProcessRecording, Recording
...
class DirectoryMultiProcessingAnalyzer:
    ...
    def process(self):
        ...
        files = []
        for pattern in patterns:
            if self.search_subdirs:  # Add 'self.' to access the instance variable
            ...
            analyzer_args = [
                {
                    ...
                    "classifier_labels_path": (
                        i.classifier_labels_path
                        if hasattr(i, "classifier_labels_path")
                        else None
                    ),
                    "classifier_model_path": (
                        i.classifier_model_path
